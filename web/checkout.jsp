                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="Card Number" class="form-control" required="" id="cardno"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="MM/YY" class="form-control" required="" id="exp"/>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <H5>Security Code</H5>
                                    </div>
                                    <input placeholder="3 or 4 Digits" class="form-control" required="" id="sec"/>
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="First Name" class="form-control" required="" id="cardfname"/>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <H5>Last Name</H5>
                                    </div>
                                    <input placeholder="Last Name" class="form-control" required="" id="cardlname"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div id="ad1"><%=ad.getAddress()%></div>
                                <div id="ad2"><%=ad.getCity() + " " + ad.getState().getState() + " " + ad.getZip()%></div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" placeholder="Address" class="form-control" id="address" value="<%=ad.getAddress()%>"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" placeholder="City" class="form-control" id="city" value="<%=ad.getCity()%>"/>
                                                </div>
                                            </div>
                                            <br/>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" placeholder="Postal Code (Zip)" class="form-control" id="pcode" value="<%=ad.getZip()%>"/>
                                                </div>
                                            </div>
                                            <br/>
                                            <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="ad4"><%=ad2.getAddress()%></div>
                                <div id="ad5"><%=ad2.getCity() + " " + ad2.getState().getState() + " " + ad2.getZip()%></div>
                            ...
                            <div class="col-md-12">
                                <div style="border: solid #999999 1px"></div>
                                <h4 id="name"><%=us.getFname() + " " + us.getLname()%></h4>
                                <div id="ad4"><%=ad.getAddress()%></div>
                                <div id="ad5"><%=ad.getCity() + " " + ad.getState().getState() + " " + ad.getZip()%></div>
                                <div id="ad6"><%=us.getMobile()%></div>
                                <a href="#" data-toggle="modal" data-target="#myModal2">Change</a>
                            </div>
                            <%
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            %>
                            <label class="pull-right">LKR. <%=adr.getState().getDeliveryPrice() %></label>
                        </div>
                        <br/>
                        <div class="col-md-8">
                        ...
                        <button class="btn btn-primary btn-block" onclick="pay()"><strong>Confirm and Pay</strong></button>
                    </div>
                </div>
            </div>
        </div>
