                                                ...
                                                <div class="item  active">
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <div>
                                                                <img alt="" src="../adminPanel/men/3PCS-LOT-Men-s-wear-short-sleeved-short-man-short-sleeved-s-t-shirts-Brand-N.jpg"  class="img-responsive">
                                                                <img class="new" src="../img/new.png" style="height: 40px; width: 40px; margin-top: 5px; margin-right: 20px">
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/Mens-Casual-Clothing-Styles3.jpg" class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-4">
                                                                        <h3>Casual</h3>
                                                ...
                                                <div class="item">
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/Mens-Colored-Suits-2015-New-Arrival-Casual-Blazer-Masculino-Korean-Style-Mens-Stage-Wear-Slim-Fit.jpg"  class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/Mens.Style_.Inspiration.Spring.Sweater.Denim_.Jacket.1.4.jpg" class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <h3>iPhone 6</h3>
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/dapper-look-streetstyle-men.jpg" class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <h3>Lumia 1520</h3>
                                                ...
                                                <div class="item">
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/dazzio-black-plain-men-party-wear-shirt-dzsh11.jpg" class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <h3>Galaxy S5</h3>
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/dazzio-grey-plain-men-party-wear-shirt-dzsh2.jpg"  class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <h3>iPhone 6</h3>
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <div class="thumbnail" >
                                                            ...
                                                            <img src="../adminPanel/men/dazzio-purple-plain-men-party-wear-shirt-dzsh27.jpg" class="img-responsive">
                                                            <div class="caption">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-xs-6">
                                                                        <h3>Lumia 1520</h3>
