    ...
    <div class="row">
        <nav class="navbar navbar-default navbar-fixed-top" style="max-height: 50px">
            ...
            <div class="collapse navbar-collapse js-navbar-collapse">
                <img src="../anita.ico" style="width: 50px; height: 40px; float: left; padding-top: 3px; min-height: 50px; padding-left: 5px">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="../site/Contact.jsp"><span></span>Contact</a></li>
                </ul>				
