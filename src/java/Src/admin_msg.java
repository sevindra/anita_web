 ...
 * @author Sevi
 */
@WebServlet(name = "admin_msg", urlPatterns = {"/admin_msg"})
public class admin_msg extends HttpServlet {
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            if (message_btn != null) {
                ...
                User user = (User) objsave.getses().load(User.class, Integer.parseInt(uid));
